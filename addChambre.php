<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $apiUrl = 'http://localhost:8090/chambre/ajout';
...
<body>
    ...
    <form method="post" action="">
        <label for="numeroChambre">Name:</label>
        <input type="text" id="numeroChambre" name="numeroChambre" value="<?php echo htmlspecialchars($numeroChambre); ?>" required>
        <br>
